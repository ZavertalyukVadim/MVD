                ...
                <div class="content">
                    ...
                    <div class="table-wrapper">
                        <table class="alt">
                            ...
                            <tbody>
                            <tr>
                                <td>Відділення амбулаторноі<br> психіатричної допомоги<br> (ВАПД)</td>
                                <td>Кабінет психопрофілактики<br> та професійного психофізіологічного<br> відбору (КПППВ)</td>
                            </tr>
                            <tr>
